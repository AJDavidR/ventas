<div class="row">
    ...
    <div class="card">
        ...
        <ul class="users-list clearfix">
            ...
            <li>
            <x-image :item="$seller" />
            <a href="{{ route("users.show", $seller) }}" class="users-list-name mt-2">{{ $seller->name }}</a>
            <span>{{ money($seller->total) }}</span>
            </li>
            @endforeach
    ...
    <div class="card">
        ...
        <ul class="users-list clearfix">
            ...
            <a href="{{ route("clients.show", $client) }}" class="users-list-name mt-2">{{ $client->name }}</a>
