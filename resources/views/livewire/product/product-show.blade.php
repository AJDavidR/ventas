<div>
    <x-card cardTitle="Detalles de producto">
        <x-slot:cardTools>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-sm-5">
                        <div class="col-12">
                            <img src="{{ $product->imagen }}" class="img-fluid" alt="Product Image">
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span
                                            class="info-box-number">{{ $product->created_at->format('Y - m - d') }}</span>
                                    </div>
                                    <!-- /.info-box-content -->
                                </div>
                            </div>
